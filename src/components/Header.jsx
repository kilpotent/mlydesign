...
export default function Header() {
  ...
  const categories = [
    { key: "all", label: t("nav_all") },
    { key: "branding", label: t("nav_branding") },
    { key: "logo", label: t("nav_logo") },
    { key: "prints", label: t("nav_prints") },
    { key: "packaging", label: t("nav_packaging") },
  ];

  return (
    <header className="menu-container" role="banner">
      <button
      ...
      <nav className="menu-bar" aria-label="Portfolio categories">
        {categories.map((cat) => (
          <Link
            key={cat.key}
            to={`/?category=${cat.key}`}
            ...
            className={
              !isAboutPage && activeCategory === cat.key ? "active" : ""
            }
          >
            {cat.label}
          </Link>
      ...
      <nav className="menu-bar" id="about" aria-label="Secondary navigation">
        ...
        <a
          href="https://www.facebook.com/profile.php?id=61584868597929"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Facebook"
        >
